    ...
    <div className="p-4 space-y-4">
      <div className="card">
        ...
        <div className="grid grid-cols-2 gap-3">
          {all.map(a=>(
            <div key={a.code} className={"p-3 rounded-xl border text-sm flex items-center gap-2 " + (unlocked.has(a.code)? "border-green-300 bg-green-50":"border-slate-200 opacity-70")}>
